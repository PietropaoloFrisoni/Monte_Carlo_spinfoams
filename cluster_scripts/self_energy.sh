...
FILE_WITH_BOOSTERS_ON_CLUSTER=Boosters_gamma_01_shell_11_isolated

JULIA_DIR=${JULIA_DIR}
BASE_DIR=${ROOT_DIR}/Monte_Carlo_spinfoams
CODE_TO_RUN=self_energy_EPRL_MC_flying_sampling
SL2CFOAM_DATA_DIR=${SLURM_TMPDIR}/${FILE_WITH_BOOSTERS_ON_CLUSTER}
CUTOFF=10
JB=0.5
DL_MIN=0
DL_MAX=1
...
tar -xvf ${BOOSTER_DIR}/${FILE_WITH_BOOSTERS_ON_CLUSTER}.tar.gz -C $SLURM_TMPDIR/
